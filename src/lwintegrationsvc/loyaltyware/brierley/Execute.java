...
public class Execute implements org.apache.axis2.databinding.ADBBean {
	...
	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"urn:Brierley.LoyaltyWare.LWIntegrationSvc", "Execute", "ns2");
	...
	protected java.lang.String localSourceEnv;
	 ...
	 * include this field in the serialized XML
	 */
	protected boolean localSourceEnvTracker = false;

	public boolean isSourceEnvSpecified() {
		return localSourceEnvTracker;
	}
	 ...
	 * @return java.lang.String
	 */
	public java.lang.String getSourceEnv() {
		return localSourceEnv;
	}
	 ...
	 *            SourceEnv
	 */
	public void setSourceEnv(java.lang.String param) {
		localSourceEnvTracker = true;

		this.localSourceEnv = param;
	...
	public void serialize(final javax.xml.namespace.QName parentQName,
		...
		if (serializeType) {
			...
			java.lang.String namespacePrefix = registerPrefix(xmlWriter,
					"urn:Brierley.LoyaltyWare.LWIntegrationSvc");
		...
		if (localSourceEnvTracker) {
			namespace = "urn:Brierley.LoyaltyWare.LWIntegrationSvc";
			writeStartElement(null, namespace, "sourceEnv", xmlWriter);

			if (localSourceEnv == null) {
				// write the nil attribute
				...
				xmlWriter.writeCharacters(localSourceEnv);
	...
	private static java.lang.String generatePrefix(java.lang.String namespace) {
		if (namespace.equals("urn:Brierley.LoyaltyWare.LWIntegrationSvc")) {
			return "ns2";
		}
	...
	public javax.xml.stream.XMLStreamReader getPullParser(
		...
		if (localSourceTracker) {
			elementList.add(new javax.xml.namespace.QName(
					"urn:Brierley.LoyaltyWare.LWIntegrationSvc", "source"));
		...
		if (localSourceEnvTracker) {
			elementList.add(new javax.xml.namespace.QName(
					"urn:Brierley.LoyaltyWare.LWIntegrationSvc", "sourceEnv"));

			elementList.add(localSourceEnv == null ? null
					: org.apache.axis2.databinding.utils.ConverterUtil
							.convertToString(localSourceEnv));
		}
		if (localExternalIdTracker) {
			elementList.add(new javax.xml.namespace.QName(
					"urn:Brierley.LoyaltyWare.LWIntegrationSvc", "externalId"));

			elementList.add(localExternalId == null ? null
					: org.apache.axis2.databinding.utils.ConverterUtil
							.convertToString(localExternalId));
		}
		if (localPayloadTracker) {
			elementList.add(new javax.xml.namespace.QName(
					"urn:Brierley.LoyaltyWare.LWIntegrationSvc", "payload"));

			elementList.add(localPayload == null ? null
					: org.apache.axis2.databinding.utils.ConverterUtil
							.convertToString(localPayload));
		}
		...
		public static Execute parse(javax.xml.stream.XMLStreamReader reader)
			...
			try {
						...
						if (!"Execute".equals(type)) {
							...
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (Execute) lwintegrationsvc.loyaltyware.brierley.ExtensionMapper
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName(
								"urn:Brierley.LoyaltyWare.LWIntegrationSvc",
								"sourceEnv").equals(reader.getName())) {
					...
					if (!"true".equals(nillableValue)
						...
						object.setSourceEnv(org.apache.axis2.databinding.utils.ConverterUtil
								.convertToString(content));
				...
				if (reader.isStartElement()
					...
					if (!"true".equals(nillableValue)
						...
						object.setExternalId(org.apache.axis2.databinding.utils.ConverterUtil
								.convertToString(content));
				...
				if (reader.isStartElement()
					...
					if (!"true".equals(nillableValue)
						...
						object.setPayload(org.apache.axis2.databinding.utils.ConverterUtil
								.convertToString(content));
